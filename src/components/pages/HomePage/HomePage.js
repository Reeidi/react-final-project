        ...
        <section id="content">
            <div class="container_12">
                <div class="grid_4 bot-1">
                    ...
                    <p>The PSD source files of this Art School Template are available for free for the registered members of
                        TemplateMonster.com. Feel free to <br />
                        get them!</p>
                    <p class="text-1 top-2 p3">April 01 - “Smile!”</p>
                    <p>This website template has several pages: Home Page, About Us, Schedule, Gallery, Contact Us (note that
                        contact us form – <br />
                        doesn’t work).</p>
                ...
                <div class="grid_8">
                    <div class="pad-1">
                        ...
                        <p class="text-1">Art School is one of free website templates by TemplateMonster.com team. This template is
                            optimized for 1280X1024 screen resolution. It is also XHTML &amp; CSS valid.</p>
                    </div>
                    <div class="block-1">
